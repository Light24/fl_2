  ...
  <div class="drop-element-block">
      ...
      <? foreach ($categories as $item_c) { ?>
          <div class="right-drop">
              <a style="line-height:3" href="/<?= $linkPrefix ?>/<?=$item_c['id']?><? if (isset($_GET['q'])) echo '?q=' . $_GET['q']; ?>" class="btn right-btn dropdown-toggle <?if (isset($uid) && $item_c['id'] == $uid){?>right-bt-active<?}?>" <!--data-toggle="dropdown"-->
              <?= $item_c['category'] ?>
              </a>
