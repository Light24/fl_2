<div class="center-block">
    ...
    <div class="result-block">
        <div class="leader-result">
            ...
            <ul class="result-ul">
                <li <? if (strcmp($duration_type, 'week') == 0 ) :?> class = 'active' <? endif ?>><a href = '/user/leaders/<?= $select_category ?>/week/<?= $cid ?>'>за неделю</a>
                </li>
                <li <? if (strcmp($duration_type, 'all') == 0 ) :?> class = 'active' <? endif ?>><a href = '/user/leaders/<?= $select_category ?>/all/<?= $cid ?>'>за все время</a>
                </li>
            </ul>
        </div>
